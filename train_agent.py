...
if __name__ == "__main__":
    for death in [0]:
        for survival in [0, 1]:
            ...
            for bounce in [0]:
                for score in [1, 0]:
                    for enemy_distance in [0, 10]:
                        path = f"models/death{death}_survival{survival}_bounce{bounce}_score{score}_enemies{enemy_distance}/"
                        ...
                        try:
                            model.learn(total_timesteps=25000000, progress_bar=True)
